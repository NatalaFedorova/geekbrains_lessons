...
Ветка — это просто указатель какого-то коммита. Каждый коммит знает, какой коммит был до него, когда ветка указывает на какой-то коммит, к ней относятся и все те предыдущие. 
